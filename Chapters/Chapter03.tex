...
Intersecting them with the finite index subgroup \(W'\) doesn't affect the cofinality and thus, the sequence of subgroups formed by the groups \(W_i\) is again cofinal. % TODO: fix this paragraph
